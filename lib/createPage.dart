...
Color textInputColor = Color.fromARGB(255, 153, 255, 223);
...
Map<String, dynamic> defaultEvent = {
  "id": fullEventList.length,
  "title": "",
  "author": accountDetails["username"],
  "maxNumOfPeople": "5",
  ...
  "description": "",
  "type": "WALKING",
  "location": [], //list of points, each point is a list made of latitude and longitude, both doubles
};
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
        nameField("Name of Event", "Think of something eye-catching..."),
        ...
        Divider(
            ...
            endIndent: 20,
            thickness: 1.5),
        topicField(topics.isEmpty ? "No topics selected." : "Topics selected:"),
        Divider(
            color: Color.fromARGB(65, 0, 126, 72),
            height: 25,
            indent: 20,
  ...
  Widget topicField(String title) {
    return Column(
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            showSelectTopicWindow(context, "Select topic...");
          },
          child: Text(
            "SELECT TOPICS",
            style: spaceStyle(),
  ...
  Widget timeSelectionButtons(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          Column(children: [
            Text("Date", style: spaceStyle(fontSize: 18)),
          ...
          Row(
            ...
            children: [
              Column(children: [
                Text("Start Time", style: spaceStyle(fontSize: 18)),
                ElevatedButton(
              ...
              Column(children: [
                Text("End Time", style: spaceStyle(fontSize: 18)),
                ElevatedButton(
              ...
              actions: [
                TextButton(
                    ...
                    child: Text(
                      "CLOSE",
                      style:
                          spaceStyle(fontSize: 21, color: Colors.red.shade700),
                    )),
                TextButton(
                    onPressed: () {
                      closeWindow(context);
                    ...
                    child: Text(
                      "CONFIRM",
                      style: spaceStyle(
                          fontSize: 21, color: Colors.green.shade700),
                    ))
              ],
            ));
  }
    ...
    return Padding(
      ...
      child: Center(
        child: ElevatedButton(
          onPressed: () {
            if (validateEntries()) {
              fullEventList.add(createdEvent);
              //upcomingEvents.add(createdEvent); //when creating, immediately add to upcoming events list.
              ...
              showSnackbar(context, "Creating event...",
                  bgColor: Colors
                      .teal); //indicate that the values are filled correctly
              //TODO ADD THE EVENT INFO INTO THE DATABASE HERE!!!!!!!
